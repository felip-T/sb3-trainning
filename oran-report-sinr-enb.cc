...
OranReportSinrEnbSql::GetTypeId()
{
    static TypeId tid = TypeId("ns3::OranReportSinrEnbSql")
                            ...
                            .AddAttribute("numUes",
                                          "Number of UEs connected to the eNB",
                                          DoubleValue(),
                                          MakeUintegerAccessor(&OranReportSinrEnbSql::m_numUes),
                                          MakeUintegerChecker<uint64_t>())
                            .AddAttribute("SINR",
                                          "Avg SINR",
                                          DoubleValue(),
    ...
    : OranReportSql()
{
    ...
    m_tableInfo.emplace_back("numUes", "INTEGER");
...
OranReportSinrEnbSql::ToString() const
{
    ...
    ss << "OranReportSinrEnb("
       ...
       << ";cellid=" << m_cellId << ";numUes=" << m_numUes << ";sinr=" << m_sinr
       << ";rsrp=" << m_rsrp << ")";
...
uint64_t
OranReportSinrEnbSql::GetCellId() const
{
    NS_LOG_FUNCTION(this);
